...
import PDFStats from '../../../components/PDFStats.astro';
...
- **[Comprehensive First Aid Manual](/pdfs/medical/ComprehensiveFirstAid.pdf)** (PDF, 903KB)
  - Emergency medical response
  - Common injury treatment
  - Group medical planning

- **[Street Medic Handbook](/pdfs/medical/street-medic-handbook.pdf)** (PDF, 700KB)
...
:::note[Updates]
Watch the GitHub repository for notifications of new file additions.
:::
